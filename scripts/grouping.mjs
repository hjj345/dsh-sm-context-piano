...
assert.equal(railLeftOf(580), 498)
assert.equal(railLeftOf(132), 50)
assert.equal(railLeftOf(124), 50)
assert.equal(railLeftOf(100), 26)
assert.equal(railLeftOf(580, 100), 398)
